...
void CheckingAccount::newChecking(int _ID, string _fname, string _lname, string _address, string _email, int _phone, double _balance, int _wds, int _depos, int _pts, double _overDL) {
	overDraftLimit = _overDL;
